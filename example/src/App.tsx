  ...
  return (
    <div className="App">
      ...
      <Pagination
        ...
        btn_range={15}
        onChange={(page) => {setCurrentPage(page)}}
        firstBtnIcon={<TbPlayerTrackPrevFilled />}
        lastBtnIcon={<TbPlayerTrackNextFilled />}
        prevBtnIcon={<GiPreviousButton />}
        nextBtnIcon={<GiNextButton />}
        pageButtonClassName='pagination_3_pageBtn'
        pageButtonSelectedClassName='pagination_3_pageBtn_selected'
        infoSectionClassName='pagination_3_infosection'
      />
      <br />
      <Pagination
        dataLength={data.length}
      ...
      <Pagination
        ...
        btn_range={7}
        onChange={(page) => {setCurrentPage(page)}}
        firstBtnIcon={<MdSkipPrevious />}
        lastBtnIcon={<MdSkipNext />}
        prevBtnIcon={<GrFormPreviousLink />}
        nextBtnIcon={<GrFormNextLink />}
        pageButtonClassName='pagination_5_pageBtn'
        pageButtonSelectedClassName='pagination_5_pageBtn_selected'
        infoSectionClassName='pagination_5_infosection'
      />
      <br />
    </div>
  );
